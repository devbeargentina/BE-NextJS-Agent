...
const API = createAPI("https://api-userauth.azurewebsites.net");//(process.env.NEXT_PUBLIC_AUTH_API_ENDPOINT?? "https://api-userauth.azurewebsites.net"));
...
const userSlice = createSlice({
  ...
  initialState: {
    ...
    isUserLoggedIn: null,
    userType: null,
    hotelMargineType: "fix",
    flightMargineType: "perc",
    hotelMargineValue: 10,
    flightMargineValue: 10,
    error: "",
    loading: false,
    token: null,
  },
