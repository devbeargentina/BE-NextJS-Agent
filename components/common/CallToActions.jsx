  ...
  return (
    <section className="layout-pt-md layout-pb-md bg-dark-2">
      <div className="container">
        <div className="row y-gap-30 justify-between xl:justify-center items-center">
          <div className="col-auto">
            <div className="row y-gap-20  xl:justify-center flex-wrap items-center">
              <div className="col-auto">
                <div className="icon-newsletter text-60 sm:text-40 text-white" />
              </div>
              <div className="col-auto xl:text-center ">
