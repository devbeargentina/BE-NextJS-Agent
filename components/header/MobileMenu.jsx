      ...
      {/* End pro-header */}
        ...
        <Sidebar width="400" backgroundColor="#fff">
          ...
          <MenuItem
            ...
            <SubMenu label="Home" className={ homeItems.some((item=>item.routePath?.split('/')[1] == pathname.split('/')[1])) ? "menu-active-link invisible":'invisible'}>
            ...
            <SubMenu label="Categories" className={isActiveParent ? 'menu-active-link invisible':'invisible' }>
            ...
            <SubMenu label="Blog" className={ blogItems.some((item=>item.routePath?.split('/')[1] == pathname.split('/')[1])) ? "menu-active-link invisible":'invisible'}>
            ...
            <SubMenu label="Pages" className={ pageItems.some((item=>item.routePath?.split('/')[1] == pathname.split('/')[1])) ? "menu-active-link invisible":'invisible'}>
            ...
            <SubMenu label="Dashboard" className={ pathname.split('/')[1] == 'dashboard'  || pathname.split('/')[1] == 'vendor-dashboard' ? "menu-active-link invisible":'invisible'}>
