                ...
                <tbody>
                  <tr style={{ background: '#ffffff'}}>
                    ...
                    <td width="312" valign="bottom" style={{ padding: '35px 0', color: '#0d2857', textAlign: 'left' }}>
                      <span className="il">Hotel</span> Invoice
                    </td>
                  </tr>
                </tbody>
              </table>
                ...
                <tbody>
                  ...
                  <tr>
                    <td
                      ...
                      valign="top"
                    >
                      <strong>Base Price:</strong> {params?.bookingResponse?.Reservation?.Items?.HotelItem?.Prices?.Price["@Currency"] + " " + params?.bookingResponse?.Reservation?.Items?.HotelItem?.Prices?.Price?.TotalFixAmounts?.Service["@Amount"]} <br />
                      <strong>Service Tax:</strong> {params?.bookingResponse?.Reservation?.Items?.HotelItem?.Prices?.Price["@Currency"] + " " + params?.bookingResponse?.Reservation?.Items?.HotelItem?.Prices?.Price?.TotalFixAmounts?.ServiceTaxes["@Amount"]} <br />
                      <strong>Total:</strong> {params?.bookingResponse?.Reservation?.Items?.HotelItem?.Prices?.Price["@Currency"] + " " + params?.bookingResponse?.Reservation?.Items?.HotelItem?.Prices?.Price?.TotalFixAmounts["@Nett"]} <br />
